...
class SlideCover(CoverEntity):
    ...
    def is_opening(self) -> bool:
        ...
        return self._slide["state"] == CoverState.OPENING

    @property
    def is_closing(self) -> bool:
        """Return if the cover is closing or not."""
        return self._slide["state"] == CoverState.CLOSING
    ...
    def is_closed(self) -> bool | None:
        ...
        if self._slide["state"] is None:
            return None
        return self._slide["state"] == CoverState.CLOSED
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        """Open the cover."""
        self._slide["state"] = CoverState.OPENING
        await self._api.slide_open(self._id)

    async def async_close_cover(self, **kwargs: Any) -> None:
        """Close the cover."""
        self._slide["state"] = CoverState.CLOSING
